...
| **Уведомления**              | Показывает уведомления в браузере при упоминаниях.                                                         |
...
| Чёрный список           | пусто                | Перечень ников через точку с запятой                      |
| Уведомления об упоминаниях | пусто                | Показывает уведомления в браузере когда кто-то упоминает вас в чате |
